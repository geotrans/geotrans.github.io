...
**Srirama Bhamidipati** is a contributor to GAMA since 2013 and is a GAMA evangelist. GAMA is developed by several teams under the umbrella of the IRD/UPMC international research unit UMMISCO. 

\


## **GAMA** - Agent-based Modeling Software
